...
if node['platform_family'] == 'suse'
  if node['lsb']['codename'] == 'UVP'
    template '/etc/init.d/openstack-nova-api' do
      source 'openstack-nova-api.service.erb'
      owner "root"
      group "root"
      mode 00755
    end
...
ruby_block "service nova-api restart if necessary" do
  block do
    Chef::Log.info("service nova-api restart")
  end
