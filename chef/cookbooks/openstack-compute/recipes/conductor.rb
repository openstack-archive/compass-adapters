...
if node['platform_family'] == 'suse'
  if node['lsb']['codename'] == 'UVP'
    template '/etc/init.d/openstack-nova-conductor' do
      source 'openstack-nova-conductor.service.erb'
      owner "root"
      group "root"
      mode 00755
    end
...
ruby_block "service nova-conductor restart if necessary" do
  block do
    Chef::Log.info("service nova-conductor restart")
  end
  not_if "service #{platform_options['compute_conductor_service']} status"
