...
# EPEL repo
default["openstack"]["yum"]["epel"]["url"] = "http://mirrors.fedoraproject.org/mirrorlist?repo=epel-#{node['platform_version'].to_i}&arch=$basearch"

if node['platform_version'].to_i >= 6
  set["openstack"]["yum"]["epel"]["key"] = "RPM-GPG-KEY-EPEL-6"
else
  set["openstack"]["yum"]["epel"]["key"] = "RPM-GPG-KEY-EPEL"
end
...
# tenant and user
default['openstack']['identity']['admin_token'] = "openstack_identity_bootstrap_token"
...
default['openstack']['identity']['compute']['username'] = "nova"
default['openstack']['identity']['compute']['password'] = "admin"
default['openstack']['identity']['compute']['role'] = default['openstack']['identity']['roles']['admin']

default['openstack']['identity']['network']['username'] = "quantum"
default['openstack']['identity']['network']['password'] = "admin"
default['openstack']['identity']['network']['role'] = default['openstack']['identity']['roles']['admin']

default['openstack']['identity']['volume']['username'] = "cinder"
default['openstack']['identity']['volume']['password'] = "admin"
default['openstack']['identity']['volume']['role'] = default['openstack']['identity']['roles']['admin']

default['openstack']['identity']['image']['username'] = "glance"
default['openstack']['identity']['image']['password'] = "admin"
default['openstack']['identity']['image']['role'] = default['openstack']['identity']['roles']['admin']

default['openstack']['identity']['objectstorage']['username'] = "swift"
default['openstack']['identity']['objectstorage']['password'] = "admin"
default['openstack']['identity']['objectstorage']['role'] = default['openstack']['identity']['roles']['admin']
...
default["openstack"]["mq"]["bind_address"] = "0.0.0.0"
