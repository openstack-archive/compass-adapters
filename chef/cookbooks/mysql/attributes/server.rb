...
#    item = data_bag_item('openstack',node['mycluster'])
#else
#    item = data_bag_item('openstack','env_default')
#end

#binding_interface = item['network']['control']['interface']
#file = File.open('/home/test.txt','w')
#file.write(binding_interface)
