...
#listen_address = address_for node["openstack"]["mq"]["bind_interface"] unless defined?(node['openstack']['mq']['bind_address'])
listen_address = node['openstack']['mq']['bind_address']
