...
when 'debian'
  ...
  default['nagios']['server']['service_name']   = 'nagios4'
...
when 'rhel', 'fedora'
  ...
  default['nagios']['home']          = '/usr/lib/nagios4'
  default['nagios']['conf_dir']      = '/etc/nagios4'
  default['nagios']['config_dir']    = '/etc/nagios4/conf.d'
  default['nagios']['log_dir']       = '/var/log/nagios4'
  default['nagios']['cache_dir']     = '/var/cache/nagios4'
  default['nagios']['state_dir']     = '/var/lib/nagios4'
  default['nagios']['run_dir']       = '/var/run/nagios4'
  default['nagios']['docroot']       = '/usr/share/nagios4/htdocs'
end
...
default['nagios']['server']['vname'] = 'nagios4'
...
default['nagios']['server']['packages'] = %w(nagios4 nagios-nrpe-plugin nagios-images)
...
# this is a "url" in the sense it should resolve if  http:// is used infront of it
default['nagios']['url']                         = 'os-nagios'
