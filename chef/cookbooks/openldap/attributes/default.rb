...
default['openldap']['basedn'] = "dc=iiis,dc=co"
default['openldap']['server'] = "10.1.0.201"
default['openldap']['tls_enabled'] = true
default['openldap']['pam_password'] = 'md5'

default['openldap']['passwd_ou'] = 'users'
default['openldap']['shadow_ou'] = 'users'
default['openldap']['group_ou'] = 'Group'
